// Ambil data dari localStorage dan tampilkan riwayat pemesanan
...
function confirmOrder() {
    const orderConfirmation = `
        <div style="text-align: center;">
            ...
            <p>Apakah Anda yakin ingin mengonfirmasi pesanan melalui Transfer?</p>
...
function handleConfirm() {
    ...
    window.location.href = 'konfirmasi transfer.html'; 
}
